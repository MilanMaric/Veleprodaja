...
create view stavka_kalkulacija_view(RedniBroj,RedniBrojStavke,SifraRoba,Kolicina,NabavnaCijena,Rabat,NetoNabavnaCijena,VeleprodajnaCijena,RazlikaUCijeni,NabavnaVrijednost,VeleprodajnaVrijednost)as
select RedniBroj,RedniBrojStavke,SifraRoba,Kolicina,NabavnaCijena,Rabat,NabavnaCijena-NabavnaCijena*Rabat/100 as NetoNabavnaCijena,VeleprodajnaCijena, VeleprodajnaCijena-(NabavnaCijena-NabavnaCijena*Rabat) as RazlikaUCijeni, Kolicina*(NabavnaCijena-NabavnaCijena*Rabat/100) as NabavnaVrijednost,Kolicina*(VeleprodajnaCijena) as VeleprodajnaVrijednost from veleprodaja.stavka_kalkulacije;

create view stavka_kalkulacija_view1(RedniBroj,RedniBrojStavke,SifraRoba,Naziv,SifraJediniceMjere,OpisJediniceMjere,Kolicina,NabavnaCijena,Rabat,NetoNabavnaCijena,VeleprodajnaCijena,RazlikaUCijeni,NabavnaVrijednost,VeleprodajnaVrijednost)as
select RedniBroj,RedniBrojStavke,sk.SifraRoba,Naziv,jm.SifraJediniceMjere,OpisJediniceMjere,Kolicina,NabavnaCijena,Rabat,NabavnaCijena-NabavnaCijena*Rabat/100 as NetoNabavnaCijena,VeleprodajnaCijena, VeleprodajnaCijena-(NabavnaCijena-NabavnaCijena*Rabat) as RazlikaUCijeni, Kolicina*(NabavnaCijena-NabavnaCijena*Rabat/100) as NabavnaVrijednost,Kolicina*(VeleprodajnaCijena) as VeleprodajnaVrijednost from veleprodaja.stavka_kalkulacije sk inner join veleprodaja.roba v on sk.SifraRoba=v.SifraRoba inner join veleprodaja.jedinica_mjere jm on v.SifraJediniceMjere=jm.SifraJediniceMjere;
delimiter $$
